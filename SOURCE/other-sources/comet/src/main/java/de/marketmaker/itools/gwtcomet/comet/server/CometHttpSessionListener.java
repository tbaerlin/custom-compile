 ...
 * "de.marketmaker.itools.gwtcomet.comet.server.auto.create.comet.session" to "true".
 * 
 * Configure it in your web.xml as follows:
 * 
 * <pre>
 * <listener>
 *   <listener-class>de.marketmaker.itools.gwtcomet.comet.server.CometHttpSessionListener</listener-class>
 * </listener>
 * <context-param>
 *   <param-name>de.marketmaker.itools.gwtcomet.comet.server.auto.create.comet.session.with.http.session</param-name>
...
public class CometHttpSessionListener implements HttpSessionListener {
	...
	public static final String AUTO_CREATE_COMET_SESSION = "de.marketmaker.itools.gwtcomet.comet.server.auto.create.comet.session.with.http.session";
