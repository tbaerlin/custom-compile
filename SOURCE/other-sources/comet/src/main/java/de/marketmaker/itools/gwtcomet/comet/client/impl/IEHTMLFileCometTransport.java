...
public class IEHTMLFileCometTransport extends CometTransport {
	...
	private native IFrameElement createIFrame(IEHTMLFileCometTransport client, String html) /*-{
		...
		htmlfile.parentWindow.m = $entry(function(message) {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onMessages(Lcom/google/gwt/core/client/JsArrayString;)(arguments);
		});
		htmlfile.parentWindow.c = $entry(function(heartbeat) {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onConnected(I)(heartbeat);
		});
		htmlfile.parentWindow.d = $entry(function() {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onDisconnected()();
		});
		htmlfile.parentWindow.e = $entry(function(statusCode, message) {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onError(ILjava/lang/String;)(statusCode, message);
		});
		htmlfile.parentWindow.h = $entry(function() {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onHeartbeat()();
		});
		htmlfile.parentWindow.r = $entry(function() {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onRefresh()();
		});
		// no $entry() because no user code is reachable
		htmlfile.parentWindow.t = function() {
			client.@de.marketmaker.itools.gwtcomet.comet.client.impl.IEHTMLFileCometTransport::onTerminate()();
		};
