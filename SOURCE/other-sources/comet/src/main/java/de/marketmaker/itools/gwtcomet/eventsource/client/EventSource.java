 ...
 * the License.
 */
package de.marketmaker.itools.gwtcomet.eventsource.client;
...
public class EventSource extends JavaScriptObject {
	...
	public final native void setOnOpen(OpenHandler handler) /*-{
		...
		this.onopen = $entry(function() {
			handler.@de.marketmaker.itools.gwtcomet.eventsource.client.OpenHandler::onOpen(Lde/marketmaker/itools/gwtcomet/eventsource/client/EventSource;)(_this);
		});
	}-*/;
	...
	public final native void setOnError(ErrorHandler handler) /*-{
		...
		this.onerror = $entry(function(error) {
			handler.@de.marketmaker.itools.gwtcomet.eventsource.client.ErrorHandler::onError(Lde/marketmaker/itools/gwtcomet/eventsource/client/EventSource;)(_this);
		});
	}-*/;
	...
	public final native void setOnMessage(MessageHandler handler) /*-{
		...
		this.onmessage = $entry(function(event) {
			handler.@de.marketmaker.itools.gwtcomet.eventsource.client.MessageHandler::onMessage(Lde/marketmaker/itools/gwtcomet/eventsource/client/EventSource;Lde/marketmaker/itools/gwtcomet/eventsource/client/MessageEvent;)(_this, event);
		});
	}-*/;
}
