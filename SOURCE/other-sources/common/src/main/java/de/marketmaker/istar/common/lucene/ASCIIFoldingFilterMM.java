...
/**
 * Adaptation of {@link org.apache.lucene.analysis.ASCIIFoldingFilter}; this class
 * maps german umlauts Ä,Ö,Ü,ä,ö,ü to AE,OE,UE,ae,oe,ue whereas the original class would
 * map them to a single char without the diaeresis.<p>
 */
public final class ASCIIFoldingFilterMM extends TokenFilter {
    public ASCIIFoldingFilterMM(TokenStream input) {
        super(input);
