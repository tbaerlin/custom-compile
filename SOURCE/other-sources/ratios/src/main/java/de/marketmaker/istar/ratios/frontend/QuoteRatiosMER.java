 ...
 */
public class QuoteRatiosMER extends QuoteRatios<InstrumentRatiosMER> {
    protected static final long serialVersionUID = 1L;

    public QuoteRatiosMER(long id, InstrumentRatiosMER instrumentRatios) {
        super(id, instrumentRatios);
    }

    public PropertySupport propertySupport(int fid) {
        return RatiosPropertySupportMER.forQuote(fid);
    }
    ...
    private int lmeExpirationDate = Integer.MIN_VALUE;

    private boolean lmeComposite = false;

    private String merInstrumentenTyp = null;

    private String merHandelsmonat = null;
    ...
    public int getLmeExpirationDate() {
        return this.lmeExpirationDate;
    }

    public void setLmeExpirationDate(int value) {
        this.lmeExpirationDate = value;
    }

    public boolean getLmeComposite() {
        return this.lmeComposite;
    }

    public void setLmeComposite(boolean value) {
        this.lmeComposite = value;
    }

    public String getMerInstrumentenTyp() {
        return this.merInstrumentenTyp;
    }

    public void setMerInstrumentenTyp(String value) {
        this.merInstrumentenTyp = value;
    }

    public String getMerHandelsmonat() {
        return this.merHandelsmonat;
    }

    public void setMerHandelsmonat(String value) {
        this.merHandelsmonat = value;
    }
