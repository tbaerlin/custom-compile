 ...
 */
public class QuoteRatiosCUR extends QuoteRatios<InstrumentRatiosCUR> {
    protected static final long serialVersionUID = 1L;

    public QuoteRatiosCUR(long id, InstrumentRatiosCUR instrumentRatios) {
        super(id, instrumentRatios);
    }

    public PropertySupport propertySupport(int fid) {
        return RatiosPropertySupportCUR.forQuote(fid);
    }

    public PropertySupport propertySupport4Instrument(int fid) {
        return RatiosPropertySupportCUR.forInstrument(fid);
    }
