...
/**
 * To read RDA files version 8
 *
 * @author ytas
 */
public class RDAReader8 {

  public static void main(String[] args) throws Exception {
    if (args.length < 2) {
      System.err.println("RDAReader8 {src_rda} {type} {fieldName}");
      System.exit(1);
    }
    ...
    final FileRatioDataReader reader =
        new FileRatioDataReader(src.toFile(), typeData.getType(), typeData);
    reader.read();
