 ...
 */
public class QuoteRatiosBND extends QuoteRatios<InstrumentRatiosBND> {
    protected static final long serialVersionUID = 1L;

    public QuoteRatiosBND(long id, InstrumentRatiosBND instrumentRatios) {
        super(id, instrumentRatios);
    }

    public PropertySupport propertySupport(int fid) {
        return RatiosPropertySupportBND.forQuote(fid);
    }
