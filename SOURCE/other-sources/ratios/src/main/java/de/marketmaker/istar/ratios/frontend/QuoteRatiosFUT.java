 ...
 */
public class QuoteRatiosFUT extends QuoteRatios<InstrumentRatiosFUT> {
    protected static final long serialVersionUID = 1L;

    public QuoteRatiosFUT(long id, InstrumentRatiosFUT instrumentRatios) {
        super(id, instrumentRatios);
    }

    public PropertySupport propertySupport(int fid) {
        return RatiosPropertySupportFUT.forQuote(fid);
    }
