...
public class DiffMatchPatch {
     ...
     * @param textOld Old string to be diffed.
     * @param textNew New string to be diffed.
     * @return Linked List of Diff objects.
     */
    public LinkedList<Diff> diff_main(String textOld, String textNew) {
        return diff_main(textOld, textNew, true);
    }

    /**
     * Find the differences between two texts in line mode.
     * @param textOld Old string to be diffed.
     * @param textNew New string to be diffed.
     * @return Linked List of Diff objects.
     */
    public LinkedList<Diff> diff_lineMode(String textOld, String textNew) {
        DiffMatchPatch dmp = new DiffMatchPatch();
        LinesToCharsResult a = dmp.diff_linesToChars(textOld, textNew);
        LinkedList<Diff> diffs = dmp.diff_main(a.chars1, a.chars2);
    ...
    public String patch_addPadding(LinkedList<Patch> patches) {
        ...
        for (short x = 1; x <= paddingLength; x++) {
            builder.append(String.valueOf((char) x));
        }
