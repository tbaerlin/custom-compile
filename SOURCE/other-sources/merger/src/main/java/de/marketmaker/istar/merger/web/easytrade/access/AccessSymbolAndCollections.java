 ...
 * @author zzhao
 */
public class AccessSymbolAndCollections implements AtomAccessCollector {

  private final String quoteKey;

  private final String[] itemKeys;

  public AccessSymbolAndCollections(String quoteKey, String[] itemKeys) {
    this.quoteKey = quoteKey;
    this.itemKeys = itemKeys;
  }

  public AccessSymbolAndCollections(String[] itemKeys) {
    this("quote", itemKeys);
  }
