 ...
 */
public class GenobrokerWp2Mapping extends ParameterMappingHandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest,
        ...
        for (int i = 0; i < ids.length; i++) {
            ...
            if (tokens.length > 1) {
                ...
                markets[i] = symbols[i] + "=market,no_default,with_prices:" + StringUtils.arrayToCommaDelimitedString(mappedMarkets);
            }
        }
