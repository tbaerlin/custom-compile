 ...
 * @author zzhao
 */
public class EodHistoryReaderImplMB extends EodHistoryReaderBaseMB {

    public EodHistoryReaderImplMB(String unit) {
        super(HistoryUnit.valueOf(unit));
    }

    public EodHistoryReaderImplMB(HistoryUnit unit) {
        super(unit);
    }

    @Override
    public Map<Integer, ByteBuffer> loadData(long quote, Collection<Integer> fields)
            throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (final EodHistoryReaderImplMB reader = new EodHistoryReaderImplMB(unit)) {
