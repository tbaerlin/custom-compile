...
@Getter
@Slf4j
public class EquityDataResponse extends AbstractCDApiResponse {
  ...
  public EquityDataResponse(Result result) {
    super(result);
  }

  public EquityDataResponse(Result result, String locale) {
    super(result, locale);
  }

  public EquityDataResponse(Status errorStatus) {
    super(errorStatus);
  }

  public EquityDataResponse withIsin(String isin) {
    this.isin = isin;
    return this;
  }
  ...
  public String toString() {
    return new StringJoiner(", ", "EquityDataResponse[", "]")
