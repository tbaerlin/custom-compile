 ...
 * @author zzhao
 */
public class EodHistoryPatchReader extends EodHistoryReaderBase {

    public EodHistoryPatchReader(int capacity, Executor executorService) {
        super(HistoryUnit.Patch, capacity, executorService);
    }

    public EodHistoryPatchReader() {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (final EodHistoryPatchReader reader = new EodHistoryPatchReader()) {
