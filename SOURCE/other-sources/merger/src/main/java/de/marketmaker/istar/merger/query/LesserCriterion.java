 ...
 * @author mwohlf
 */
public class LesserCriterion extends BeanCriterion {

    private final String propertyName;
    private final String compareValue;

    LesserCriterion(String propertyName, String compareValue) {
    ...
    protected boolean doEvaluate(Method readMethod, Object bean)
        ...
        if (comparator != null) {
            ...
            throw new BeanCriterionException("can't evaluate lesser criterion for value '" + compareValue
