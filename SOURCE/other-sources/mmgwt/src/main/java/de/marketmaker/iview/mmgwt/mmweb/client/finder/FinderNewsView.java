 ...
 */
class FinderNewsView extends AbstractFinderView<FinderNews> implements ContentContainer {

    private ContentView lastContentView;

    FinderNewsView(FinderNews controller) {
        super(controller);
    }
    ...
    protected void initColumnModels(TableColumnModel[] columnModels) {
        TableCellRenderer linkRenderer = new MaxLengthStringRenderer(130, "--") { // $NON-NLS-0$
            @Override
