 ...
 * </dl>
 */
public class ContentPanel extends LayoutContainer implements IconSupport, ContentPanelIfc {
  ...
  public void setHeaderText(String headerText) {
    setHeading(SafeHtmlUtils.htmlEscape(headerText));
  }

  @Override
  public void setHeader(SafeHtml headerText) {
    setHeading(headerText.asString());
  }
  ...
  public void setTopWidget(Widget widget) {
    ...
    setTopComponent(wrapWidget(widget));
  }
  ...
  public Widget getTopWidget() {
    ...
    final Component topComponent = getTopComponent();
    return topComponent instanceof WidgetComponent
            ? ((WidgetComponent) topComponent).getWidget()
            : topComponent;
  }

  @Override
  public void setBottomWidget(Widget widget) {
    setBottomComponent(wrapWidget(widget));
  }
  ...
  @Override
  public Widget addHeaderTool(String iconClass, final HeaderToolCommand command) {
  ...
  public Widget addHeaderTool(String iconClass, String tooltip, final HeaderToolCommand command) {
    final ToolButton cfgButton = new ToolButton(iconClass);
    cfgButton.addSelectionListener(new SelectionListener<IconButtonEvent>() {
      ...
      public void componentSelected(IconButtonEvent iconButtonEvent) {
        command.execute(cfgButton);
      }
    });
    if (tooltip != null) {
      cfgButton.setToolTip(tooltip);
    }
    getHeader().addTool(cfgButton);
    return cfgButton;
  }

  @Override
  public void setToolTooltip(Widget toolWidget, String tooltip) {
    ((ToolButton)toolWidget).setToolTip(tooltip);
  }

  @Override
  public void setToolIcon(Widget toolWidget, String styleName) {
    ((ToolButton)toolWidget).changeStyle(styleName);
  }

  @Override
  public Widget addFirstHeaderIcon(String iconClass) {
    final Image image = IconImage.get(iconClass).createImage();
    image.setStyleName("mm-snippet-header-widget");
    getHeader().insertTool(wrapWidget(image), 0);
    return image;
  }
  ...
  public void setIconClass(Widget widget, String iconClass) {
    if (!(widget instanceof Image)) {
      Firebug.warn("ContentPanel.setIconClass() - unhandled widget class: " + widget.getClass().getSimpleName());
      return;
    }
  ...
  @Override
  public void enableDragging(String transfer, String logId) {
    throw new UnsupportedOperationException("ContentPanel <enableDragging> not supported by gxt ContentPanel");
  }

  @Override
  public void disableDragging() {
    throw new UnsupportedOperationException("ContentPanel <disableDragging> not supported by gxt ContentPanel");
  }
}
